...
Compared to an MK312-BT, it has 2 extra channels, two trigger inputs (think predicament bondage), and an accessory port. It has limited [bluetooth support](docs/Bluetooth.md) (mostly just remotes) and, _so far_, is missing most of the patterns of the 312. Audio input is possible with an extra/optional board.
