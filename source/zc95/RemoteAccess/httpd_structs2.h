#ifndef LWIP_HTTPD_STRUCTS2_H
#define LWIP_HTTPD_STRUCTS2_H
...
#define HTTP_HDR_AUTH_REQU_11   8 /* 501 Not Implemented */
#define HTTP_HDR_CONTENT_LENGTH 9 /* Content-Length: (HTTP 1.0)*/
#define HTTP_HDR_CONN_CLOSE     10 /* Connection: Close (HTTP 1.1) */
#define HTTP_HDR_CONN_KEEPALIVE 11 /* Connection: keep-alive (HTTP 1.1) */
#define HTTP_HDR_KEEPALIVE_LEN  12 /* Connection: keep-alive + Content-Length: (HTTP 1.1)*/
#define HTTP_HDR_SERVER         13 /* Server: HTTPD_SERVER_AGENT */
#define DEFAULT_404_HTML        14 /* default 404 body */
#define DEFAULT_511_HTML        15 /* default 511 body */
#if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
